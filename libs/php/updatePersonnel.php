...
// http://localhost/companydirectory/libs/php/updatePersonnel.php?id=1&firstName=John&lastName=Doe&jobTitle=Developer&email=jdoe@example.com&departmentID=1
